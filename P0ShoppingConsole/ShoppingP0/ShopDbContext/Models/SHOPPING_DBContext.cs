        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.HasOne(d => d.Item)
                    ...
                    .HasForeignKey(d => d.ItemId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ORDERS__ITEM_ID__17036CC0");

                entity.HasOne(d => d.OrderNoNavigation)
                    .WithMany(p => p.Orders)
                    .HasForeignKey(d => d.OrderNo)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ORDERS__ORDER_NO__160F4887");
            });

            modelBuilder.Entity<OrderNumber>(entity =>
            {
                entity.HasKey(e => e.OrderNo)
                    .HasName("PK__ORDER_NU__460AEC5705B98004");
                ...
                entity.HasOne(d => d.StoreBranch)
                    ...
                    .HasForeignKey(d => d.StoreBranchId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ORDER_NUM__STORE__68487DD7");

                entity.HasOne(d => d.UserPkNavigation)
                    .WithMany(p => p.OrderNumbers)
                    .HasForeignKey(d => d.UserPk)
                    .HasConstraintName("FK__ORDER_NUM__UserP__6754599E");
            });
