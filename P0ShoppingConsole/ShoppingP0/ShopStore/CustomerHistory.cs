...
namespace ShopStore
{
    public class CustomerHistory
    {
        ...
        public CustomerHistory(List<Cart> cart, string UserName, string address, string city, string State, string zip, string storeName, String StoreStreet, string storecity, string storestate, string
