...
namespace ShopStore
{
    public class MyCart
    {
        ...
        public MyCart(List<Cart> cart, string UserName, string address, string city, string State, string zip, string storeName, String StoreStreet, string storecity, string storestate, string
